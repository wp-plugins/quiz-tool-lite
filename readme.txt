...
*   Currently supports single response (radio), multiple response (checkbox) and reflective question types (click to reveal)
*   Embed a single question on a wordpress post or page for formative assessment (no form posting)
...
Currently you pick \'x\' questions at random from a question pot. These questions are displayed randomly. No timers are available.

More options will be available in future releases

**What question types does this support?**

Currently you can do single reponse and multiple response questions. You can also write \'reflective\' questions where you ask users to think of an answer before getting them to click a button which displays an \'ideal answer\'.
