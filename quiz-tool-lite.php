...
// Check if its part of the Uni eFolio domain and if so load up additional scripts
$thisSiteURL = get_site_url();
if (strpos($thisSiteURL,'efolio.soton.ac.uk') !== false)
{
		require_once AIQUIZ_PATH.'UoS/functions_uos.php'; #Custom UoS
}
